...
#include <algorithm> //TODO: Remove algebra::isNumber and you can delete this
#include <cmath> //TODO: Remove algebra::isNumber and you can delete this and this
...
std::string algebra::mulMonomials(std::string &a, std::string &b) {
	...
	if (a == "null" || b == "null")
		return "null";
	if (hasExponent(a) && hasExponent(b)) { //3x^2 * 4x^2 will be equal to 12x^4
	...
	else if (hasExponent(a) && !hasExponent(b)) { //3x^2 and 4x or 4
		pos = (int)a.find(exponent);
	...
	else if (!hasExponent(a) && hasExponent(b)) {
...
} //TODO: Is this needed? Parser has an identical function
